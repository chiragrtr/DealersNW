        ...
        if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
            ...
            if (xmlHttp.responseText != "") {
                ...
                for (i = records.length - 1; i >= 0; i--) {
                    ...
                    i--;
                    htmlText += "<br>MAKE: <b>" + records[i].make + "</b>,&nbsp MODEL: <b>" + records[i].model + "</b>,&nbsp COLOR: <b>" + records[i].color + "</b>,&nbsp BROADCAST DATE: " + records[i].broadcastDate + "</p>";
                    i--;
            ...
            if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
                ...
                if (xmlHttp.responseText != "") {
                    ...
                    for (i = records.length - 1; i >= 0; i--) {
                        ...
                        i = i - 1;
                        htmlText += "MAKE: <b>" + records[i].make + "</b>, MODEL: <b>" + records[i].model + "</b>, COLOR: <b>" + records[i].color + "</b><BR>" + "BROADCAST DATE: " + records[i].broadcastDate;
            ...
            if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
                ...
                if (xmlHttp.responseText != "") {
                    ...
                    for (i = records.length - 1; i >= 0; i--) {
                        ...
                        htmlText += " BROADCAST BY: " + records[i].name + ", Contact Number: " + records[i].phone + ", Email Address: " + records[i].email + "<BR>";
                        i = i - 1;
                        htmlText += "MAKE: <b>" + records[i].make + "</b>, MODEL: <b>" + records[i].model + "</b>, COLOR: <b>" + records[i].color + "</b><BR>" + "BROADCAST DATE: " + records[i].broadcastDate + "</ul></div></p>";
                    }
                }
                document.getElementById("othersBroadcasts").innerHTML = htmlText;
            }
